<template>
  <div class="agent-coorperate" v-if="siteInfo?.business_cooperation?.length">
    <div class="agent-coorperate-content">
      ...
      >
        <div
          v-for="(list, index) in siteInfo.business_cooperation"
          :key="index"
        >
          <el-image
            :src="list.icon"
      ...
      <!-- <div
        v-else-if="coorperateData.length"
        class="agent-coorperate-list"
      >
        <div
          v-for="(list, index) in coorperateData"
          :key="index"
        >
          <el-image
            :src="$getSrc(list.pic)"
